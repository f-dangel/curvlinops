...
def test_MCGGNDiagonalLinearOperator_matvec(case, adjoint: bool, is_vec: bool):
    """Test matrix-matrix multiplication with the MCGGN diagonal.
    ...
    compare_consecutive_matmats(G, adjoint, is_vec)
    compare_matmat(G, G_mat, adjoint, is_vec, atol=1e-4, rtol=2e-2)
